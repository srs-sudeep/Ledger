  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Net balance", value: summary?.net_worth ?? 0 },
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <Card className="p-6">
          ...
          <div className="space-y-3">
            ...
            {recent.length === 0 && <p className="text-secondary text-sm">No transactions yet</p>}
          </div>
        </Card>
        <Card className="p-6">
          ...
          <div className="space-y-3">
            ...
            {settlements.length === 0 && <p className="text-secondary text-sm">All settled up</p>}
          </div>
        </Card>
      </div>
    </div>
